<!-- resources/views/landpage.blade.php -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="../html/images/favicon.png"
    />
    <title>
      Maruti Admin Template - Most Advanced Dashboard Kit of All Time
    </title>
    <!-- Custom CSS -->
    <!-- <link
      href="https://demos.wrappixel.com/free-admin-templates/bootstrap/Maruti-bootstrap-free/dist/css/style.min.css"
      rel="stylesheet"
    /> -->
    <link
  ...
  <body class="lp-custom-row">
    ...
    <div id="main-wrapper">
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-9 text-center">
                <h2 class="text-dark">
                  ...
                  <span class="border-bottom border-dark"> Maruti Admin</span>
                </h2>
              </div>
            </div>
            <div class="row py-5">
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="text-center mt-4">
                      <a
                          ...
                          href="https://demos.wrappixel.com/free-admin-templates/bootstrap/maruti-bootstrap-free/html/index.html"
                          target="_blank"
                          >Live Preview</a
                        >
                      <a
                        href="https://github.com/wrappixel/maruti-admin/"
                    ...
                    <div class="row text-muted mt-4">
                      <div class="col-md-6">
                        <ul class="list-unstyled listing">
                          ...
                          <li>
                            <span class="icon-circle"></span>14+ Pages Template
                          </li>
                          <li>
                            <span class="icon-circle"></span>10+ UI Components
                          </li>
                          <li>
                            <span class="icon-circle"></span>Bootstrap 2 Version
                          </li>
                          <li>
                            <span class="icon-circle"></span>Icons
                          </li>
                          <li>
                            <span class="icon-circle"></span>Fully Responsive Pages
                          </li>
                          <li>
                      ...
                      <div class="col-md-6">
                        <ul class="list-unstyled listing">
                          ...
                          <li>
                            <span class="icon-circle"></span>Basic Table Examples
                          </li>
                          <li>
                            <span class="icon-circle"></span>Form Page Included
                          </li>
                          <li>
      ...
      <footer class="text-center p-4">
        All Rights Reserved by Maruti Admin. Designed and Developed by
